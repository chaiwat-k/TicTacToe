...
set _DeploySetParametersFile=%RootPath%CarPass.TicTacToe.WebApplication.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%CarPass.TicTacToe.WebApplication.zip" (
echo "%RootPath%CarPass.TicTacToe.WebApplication.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%CarPass.TicTacToe.WebApplication.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%CarPass.TicTacToe.WebApplication.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%CarPass.TicTacToe.WebApplication.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%CarPass.TicTacToe.WebApplication.SetParameters.xml" %_MsDeployAdditionalFlags%
...
:usage
echo =========================================================
if not exist "%RootPath%CarPass.TicTacToe.WebApplication.deploy-readme.txt" (
...
start notepad "%RootPath%CarPass.TicTacToe.WebApplication.deploy-readme.txt"
)
echo =========================================================
goto :eof
